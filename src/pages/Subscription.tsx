...
const Subscription = () => {
  ...
  useEffect(() => {
    document.title = "الاشتراك بالتأمين | JPU ER";
  }, []);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-accent/80 mt-2">
              اختر الخطة المناسبة واطلب الاشتراك بسهولة
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 ">
            {plans.map((plan) => (
              <Card
                key={plan.key}
                className="overflow-hidden border-0 shadow-card h-full"
              >
                <div
                  className={`h-4 ${
                    plan.key === "bronze"
                      ? "bg-[linear-gradient(135deg,hsl(var(--bronze-1)),hsl(var(--bronze-2)))]"
                      : plan.key === "silver"
                      ? "bg-[linear-gradient(135deg,hsl(var(--silver-1)),hsl(var(--silver-2)))]"
                      : "bg-[linear-gradient(135deg,hsl(var(--gold-1)),hsl(var(--gold-2)))]"
                  }`}
                />
                <div className="p-6 rounded plan-card bg-primary/30 hover-scale">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="text-3xl font-extrabold text-accent mt-4">
                      ...
                      <span className="text-accent/70 text-base font-normal">
                        {" "}
                        / السنة
                      </span>
                    </div>
        ...
        <Dialog open={showDialog} onOpenChange={setShowDialog}>
          <DialogContent className="sm:max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <Label htmlFor="studentId" className="text-accent">
                  الرقم الجامعي
                </Label>
                <Input
                  id="studentId"
              ...
              <div>
                <Label htmlFor="birthDate" className="text-accent">
                  تاريخ الميلاد
                </Label>
                <Input
                  id="birthDate"
              ...
              <div>
                <Label htmlFor="collegeDepartment" className="text-accent">
                  الكلية/القسم
                </Label>
                <Select
                  value={formData.collegeDepartment}
                  onValueChange={(value) =>
                    updateField("collegeDepartment", value)
                  }
                >
                  <SelectTrigger className="mt-1 text-right">
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="الهنداسة المعلوماتية">
                      الهندسة المعلوماتية
                    </SelectItem>
                    <SelectItem value="الهندسة المدنية">
                      الهندسة المدنية
                    </SelectItem>
